...
router.get("/all-customer", middlewareController.verifyTokenManager, accountController.getAllResidentAccount)
...
router.post("/register-staff", accountController.registerAccountManager)
